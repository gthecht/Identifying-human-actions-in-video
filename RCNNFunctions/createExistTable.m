function [existTable] = createExistTable(imNames, uniqNames, labels, labelsName, isMemberTable, FrameData)
...
switch choice
    ...
    case 'No'
        ...
        tic
        labelsTable = createDataTable(imNames, uniqNames, labels, labelsName, isMemberTable);
