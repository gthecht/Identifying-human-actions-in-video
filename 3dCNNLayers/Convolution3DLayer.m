classdef Convolution3DLayer < nnet.layer.Layer
% Convolution2DLayer   3-D convolution layer
    %
    %   To create a convolution layer, use convolution3dLayer
    %
    %   Convolution3DLayer properties:
    %       Name                        - A name for the layer.
    %       FilterSize                  - The height, width and length of the
    %                                     filters.
    ...
    %
    %   Example:
    %       Create a convolution layer with 5 filters of size 10-by-10-by-10.
    %
    %       layer = convolution3dLayer(10, 5);
    %
    properties
        % FilterSize   The height and width and length of the filters.
        %   This is a row vector [h w, L]
        %   where h is the filter height and w is the filter width. L is
        %   the filter Length
        FilterSize
        ...
        %   vector [t b l r f e] where t is the padding to the top, b is the 
        %   padding applied to the bottom, l is the padding applied to the 
        %   left, and r is the padding applied to the right. In addition f
        %   is the padding applied at the front, and e is the padding
        %   applied at the end.
        PaddingSize
    end
    
    methods
        function layer = Convolution3DLayer()
            layer.Name = name;
        end
    ...
    classdef Convolution3DLayer < nnet.cnn.layer.Layer & nnet.internal.cnn.layer.Externalizable
    % Convolution2DLayer   3-D convolution layer
    %
    ...
    %   Convolution3DLayer properties:
    %       Name                        - A name for the layer.
    %       FilterSize                  - The height and width and length
    %                                     of the filters.
    %       NumChannels                 - The number of channels for each
    %                                     filter.
    %       NumFilters                  - The number of filters.
